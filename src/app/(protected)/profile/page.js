...
import { Trash2, Save, Edit, User, Mail, Building, GraduationCap, Calendar, Users } from "lucide-react"
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <Input name="semester" type="number" value={editedUser.semester} onChange={handleInputChange} />
                  ) : (
        ...
        <TabsContent value="groups">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage your group memberships and activities</CardDescription>
            </CardHeader>
            <CardContent>
              {groups.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-10 text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground max-w-sm">
                    You haven't joined any groups yet. Groups help you collaborate with others on projects and studies.
                  </p>
                  <Button className="mt-4" onClick={() => router.push("/groups/browse")}>
                    Browse Groups
                  </Button>
                </div>
              ) : (
                    ...
                    <div key={group.id} className="flex items-center justify-between rounded-lg border p-4">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge variant="outline">Semester {group.semester}</Badge>
                        </div>
                      ...
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" onClick={() => router.push(`/groups/${group.id}`)}>
                          View
                        </Button>
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This will remove you from the group "{group.name}". This action cannot be undone.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
            ...
            <CardFooter className="border-t px-6 py-4">
              <Button variant="outline" onClick={() => router.push("/groups/create")}>
                Create New Group
              </Button>
            </CardFooter>
          </Card>

        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-700 mb-4">
              At Nexus, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">2. Collection of Your Information</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              ...
              information about our services from the Application.
            </p>
            ...
            <p className="text-gray-700">
              ...
              location of your device, if you access the Application from a mobile device.
            </p>
          </section>

          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">3. Use of Your Information</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">4. Disclosure of Your Information</h2>
            <p className="text-gray-700 mb-4">
              We may share information we have collected about you in certain situations. Your information may be
              disclosed as follows:
            </p>

            <h3 className="text-lg font-bold mt-6 mb-3">By Law or to Protect Rights</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">Third-Party Service Providers</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">Marketing Communications</h3>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">5. Contact Us</h2>
            <p className="text-gray-700">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link href="/privacy" className="text-gray-500 hover:text-black font-bold">
                Privacy
              </Link>

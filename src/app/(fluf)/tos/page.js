    ...
    <main className="font-sans">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">1. Agreement to Terms</h2>
            <p className="text-gray-700 mb-4">
              These Terms of Service constitute a legally binding agreement made between you and Nexus, Inc., concerning
              your access to and use of the Nexus platform. You agree that by accessing the platform, you have read,
            ...
            <p className="text-gray-700">
              ...
              platform and you must discontinue use immediately. We reserve the right, in our sole discretion, to make
              changes or modifications to these Terms of Service at any time and for any reason.
            </p>
          </section>

          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">2. User Representations</h2>
            <p className="text-gray-700 mb-4">By using the platform, you represent and warrant that:</p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                You will not access the platform through automated or non-human means, whether through a bot, script, or
                otherwise.
              </li>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">3. User Registration</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">4. Fees and Payment</h2>
            ...
            <p className="text-gray-700 mt-4">
              ...
              complete, and accurate purchase and account information for all purchases made via the platform. You
              further agree to promptly update account and payment information, including email address, payment method,
              and payment card expiration date, so that we can complete your transactions and contact you as needed.
            </p>
          </section>

          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">5. Prohibited Activities</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">As a user of the platform, you agree not to:</p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                Circumvent, disable, or otherwise interfere with security-related features of the platform, including
              ...
              <li>
                ...
                interferes with any party's uninterrupted use and enjoyment of the platform or modifies, impairs,
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-4">6. Contact Us</h2>
            <p className="text-gray-700">
              In order to resolve a complaint regarding the platform or to receive further information regarding use of
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="/terms" className="text-gray-500 hover:text-black font-bold">
                Terms
              </Link>
